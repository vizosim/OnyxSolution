...
[System.ServiceModel.ServiceContractAttribute(Namespace = "urn:ec.europa.eu:taxud:vies:services:checkVat", ConfigurationName = "checkVatPortType")]
public interface checkVatPortType
{
    ...
    System.Threading.Tasks.Task<checkVatResponse> checkVatAsync(checkVatRequest request);

    // CODEGEN: Generating message contract since the operation has multiple return values.
    [System.ServiceModel.OperationContractAttribute(Action = "", ReplyAction = "*")]
    [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults = true)]
    System.Threading.Tasks.Task<checkVatApproxResponse> checkVatApproxAsync(checkVatApproxRequest request);
}
...
[System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
public interface checkVatPortTypeChannel : checkVatPortType, System.ServiceModel.IClientChannel
{
}

[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
public partial class checkVatPortTypeClient : System.ServiceModel.ClientBase<checkVatPortType>, checkVatPortType
{
    ...
    public System.Threading.Tasks.Task<checkVatResponse> checkVatAsync(checkVatRequest request)
    {
        return base.Channel.checkVatAsync(request);
    }

    public System.Threading.Tasks.Task<checkVatApproxResponse> checkVatApproxAsync(checkVatApproxRequest request)
    {
